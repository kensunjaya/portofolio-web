      ...
      >
        ...
        <div className="flex flex-col text-justify gap-5 text-lg text-cfgray">
          ...
          <div className="flex flex-col h-fit items-center">
            <Image src="/chroma-war-prototype.png" alt="Chroma War First Ever Working Prototype" width={600} height={0} />
        ...
        <div className="flex flex-col text-justify gap-5 text-lg text-cfgray">
          ...
          <div className="flex flex-col h-fit items-center">
            <Image src="/chroma-war-final.png" alt="Chroma War Final Preview" width={600} height={0} />
